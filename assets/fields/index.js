...
import MultiMapycz from './MultiMapycz';
...
export default {
  ...
  multi_textarea: MultiTextarea,
  multi_time: MultiTime,
  multi_toggle: MultiToggle,
  multi_url: MultiUrl,
  multi_week: MultiWeek,
  number: Number,
  password: Password,
  post: Post,
  range: Range,
