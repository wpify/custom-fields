...
`min` _(string)_ — The earliest month and year that can be selected. The value should be in ISO format (YYYY-MM).

`max` _(string)_ — The latest month and year that can be selected. The value should be in ISO format (YYYY-MM).
